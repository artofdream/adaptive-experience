...
class OrchestrationPort(Protocol):
    ...
    def load_session(self, *, session_id: str, subject: str) -> dict: ...
    ...
    def create_order(self, *, session_id: str, subject: str,
                     correlation_id: str, aea_client: str | None = None) -> OrderResult: ...
...
class UnavailableOrchestration:
    ...
    def list_operator_orders(self, **kwargs) -> dict:
        return {"status": 503, "items": []}
    ...
    def load_session(self, **kwargs) -> dict:
        raise RuntimeError("orchestration unavailable")
