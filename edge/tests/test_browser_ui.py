...
class BrowserUiTests(unittest.TestCase):
    ...
    def test_checkout_is_confirmation_driven(self):
        ...
        self.assertIn("priorOrders", self.script)
        self.assertIn("need-reorder-history", self.script)
        self.assertIn("Choose a previous bouquet", self.script)
        self.assertIn("shopNeedReorder", self.script)
        self.assertIn("selectRecalledProduct", self.script)
        ...
        self.assertIn("need-reorder-modify", self.script)
        self.assertIn('id="need-reorder-modify"', self.html)
        self.assertIn("Modify →", self.html)
        self.assertIn("selectRecalledProduct", self.script)
        self.assertIn("priorOrderOptions", self.script)
        self.assertIn("shopNeedReorder", self.script)
        self.assertIn("selection-reorder-hint", self.html)
        self.assertIn("renderSelectionReorderHint", self.script)
        self.assertIn(".need-reorder", self.css)
        self.assertIn(".need-reorder-actions", self.css)
        self.assertIn('id="need-reorder-history"', self.html)
        self.assertIn(".need-reorder-choice", self.css)
        self.assertIn("FR-008", self.script)
        self.assertIn('id="need-reminder"', self.html)
        self.assertIn("Shop this occasion →", self.html)
        self.assertIn("private occasion memory", self.script)
        self.assertIn("renderNeedReminder", self.script)
        self.assertIn("firstNeedReminder", self.script)
        self.assertIn("shopNeedReminder", self.script)
        self.assertIn("need-reminder-cta", self.script)
        self.assertIn(".need-reminder", self.css)
        self.assertIn("FR-016", self.script)
    ...
    def test_florist_operator_console_is_separate_labeled_sample(self):
        ...
        self.assertIn('id="engagement"', html)
        self.assertIn('id="engagement-totals"', html)
        self.assertIn('id="engagement-occasion-rows"', html)
        self.assertIn('id="reminder-outbox"', html)
        self.assertIn('id="reminder-outbox-rows"', html)
        self.assertIn("/api/v1/operator/engagement", script)
        self.assertIn("/api/v1/operator/reminder-outbox", script)
        self.assertIn("function renderEngagement", script)
        self.assertIn("function renderReminderOutbox", script)
        self.assertIn("SAMPLE_ENGAGEMENT", script)
        self.assertIn("EMPTY_ENGAGEMENT", script)
        self.assertIn("US-017", html)
        self.assertIn("FR-017", html)
    ...
    def test_florist_engagement_analytics_are_zero_pii_counts(self):
        html = (ROOT / "ui" / "florist.html").read_text(encoding="utf-8")
        script = (ROOT / "ui" / "assets" / "florist.js").read_text(encoding="utf-8")
        self.assertIn('href="#engagement"', html)
        self.assertIn("Engagement analytics", html)
        self.assertIn("Counts and categorical keys only", html)
        self.assertIn("function renderEngagement", script)
        self.assertIn("/api/v1/operator/engagement", script)
        self.assertIn("/api/v1/operator/engagement/export", script)
        self.assertIn("function downloadEngagementExport", script)
        self.assertIn("function setEngagementExportEnabled", script)
        self.assertIn('id="engagement-export-csv"', html)
        self.assertIn('id="engagement-export-json"', html)
        self.assertIn("Download CSV", html)
        self.assertIn("Download JSON", html)
        self.assertIn("occasion_cohorts", script)
        self.assertIn("relation_cohorts", script)
        self.assertIn("event_month_cohorts", script)
        self.assertIn("spend_band_cohorts", script)
        self.assertIn("subject_count", script)
        self.assertIn('id="engagement-spend-rows"', html)
        self.assertIn("Spend band", html)
        ...
        self.assertIn("function renderReminderOutbox", script)
        self.assertIn("/api/v1/operator/reminder-outbox", script)
        self.assertIn("pending_dry_run", script)
        self.assertIn("not_implemented", script)
        self.assertIn("Attempt stub send", script)
        self.assertNotIn("browser_hash", script)
        self.assertNotIn("subject_reference", script)
        self.assertNotIn("card_number", script)
        self.assertNotIn("email", script.lower())
        self.assertNotIn("street", script.lower())
        self.assertNotIn("smtp", script.lower())
        self.assertNotIn("sendgrid", script.lower())
    ...
    def test_florist_operator_mobile_table_and_order_overlay(self):
        ...
        self.assertIn('id="operator-help-dialog"', html)
        self.assertIn('data-open-help-dialog', html)
        self.assertIn('data-close-help-dialog', html)
        ...
        self.assertIn("function openHelpDialog", script)
        self.assertIn("operatorHelpDialog", script)
        ...
        self.assertIn(".operator-help-steps", css)
