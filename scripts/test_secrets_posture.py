...
class TestSecretCandidateFixtures(unittest.TestCase):
    def setUp(self):
    ...
    def test_unignored_env_fails_and_hides_value(self):
        # Drop the ignore rule so .env is a real unignored candidate.
        _write(self.root / ".gitignore", "*.pem\n")
