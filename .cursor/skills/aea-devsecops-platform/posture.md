...
- `platform-foundation-integration` (Postgres + Kafka services,
  `AEA_INTEGRATION=1`)
- required `markdownlint` (#325); required `linkcheck` (#326); required `ruff` (#327); required `bandit` (#328); required `python-lock` (#329); required `pip-audit` (#330); required `image-digest` (#331); required `image-scan` (#332)
