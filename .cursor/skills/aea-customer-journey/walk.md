...
the same-session T-03 hint and the Need-phase Reorder card after an accepted
order).
...
| 11d | Prior SKU chooser | `#need-reorder-history` when ≥2 accepted SKUs; pick a non-latest SKU | #426; blocked unless ≥2 recalls |
