...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Seed fresh local inventory snapshots for the reference catalog.")
    ...
    parser.add_argument("--interval", type=float, default=float(os.environ.get(
        "AEA_SEED_INVENTORY_INTERVAL_SECONDS", str(DEFAULT_INTERVAL_SECONDS))),
