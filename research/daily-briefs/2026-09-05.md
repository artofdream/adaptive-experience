...
- **Hand-review 2026-09-05 (ROG Play Internal v8 #404 ABSENT):** ASUS ROG (`ASUS_I001DC`, serial `K9AIKN07B088C89`) Play Internal `versionCode` **8** / `0.1.0-alpha.8` (`com.android.vending`, non-`DEBUGGABLE`). Cold-start Need: chips only; Reorder / wallet one-tap CTA **ABSENT** — same as A36. Do not leave ROG as the preferred #404 tap prove. Do not reopen #404. New issue [#407](https://gitlab.com/artof-group/adaptive-experience-architecture/-/work_items/407). NeedScreen gate is `latestWalletReceipt != null` (no feature flag). Sponsor path (not opened here): `C:\Users\claud\Temp\aea-rog-404\`. Vault: [[2026-09-05-session-memory-log-rog-play-v8-404-absent]].
...
* [[2026-09-05-session-memory-log-rog-play-v8-404-absent]] — 2026-09-05-session-memory-log-rog-play-v8-404-absent.md
