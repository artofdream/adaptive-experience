...
| 48 | CF-048 | Daily-brief publisher hardcodes 15/16 completed and unsupported M15 pre-render/sub-100ms claims | High | queued | 2026-08-23 | 2026-08-23 | `research/assessments/2026-08-23-codex-independent-runtime-coherence-assessment.md` |
...
- Do not merge casually. Loop ticks must not merge unless
  ...
  “please merge this named MR” prompt. Uncertainty → ask the user; do
