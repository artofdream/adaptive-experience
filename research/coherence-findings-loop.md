...
findings through the Claudeâ€“Obsidian workflow. Intake may reconcile every
...
|-------|----|---------|----------|--------|------------|-----------|------------|
| 1 | CF-001 | Validate complete BGâ†’EPâ†’USâ†’FR/NFR mappings and scope, not only ID inventories | Medium | verified | 2026-08-10 | 2026-08-10 | #86 / !32 |
...
| 7 | CF-007 | T-03 recommendation cards omit the Available badge (FR-011) | Medium | verified | 2026-08-10 | 2026-08-11 | #97 / !46 Â· #113 / !64 |
| 8 | CF-008 | T-04 customization panel drops Colour and Ribbon fields | Medium | verified | 2026-08-10 | 2026-08-10 | #98 / !47 |
| 9 | CF-009 | T-08 tracking omits Contact Florist and Future T-09 escalation (FR-006) | Medium | verified | 2026-08-10 | 2026-08-11 | #99 / !48 Â· #114 / !65 |
...
| 11 | CF-011 | Wiki florist page says â€œreference implementationâ€ while repo naming uses â€œreference designâ€ | Low | verified | 2026-08-10 | 2026-08-10 | #102 / !51 |
| 12 | CF-012 | GitLab issues #79â€“#85 remain open though claims are fixed or intentional on main | Low | verified | 2026-08-10 | 2026-08-10 | #103 / !52 |
| 13 | CF-014 | Misnumbered Accepted ADR stubs (files ADR-008â€¦012 titled ADR-006â€¦010) collide with Proposed ADR-006/007 and gate issues | High | verified | 2026-08-11 | 2026-08-11 | #110 / !56 |
| 14 | CF-015 | Gate issues #106â€“#108 lack matching ADR files; slots hold unrelated tech stubs | High | verified | 2026-08-11 | 2026-08-11 | #106 / !57 Â· #107 / !58 Â· #108 / !59 |
...
| 19 | CF-019 | Wiki ADR index still lists only ADR-001â€¦005 | Low | verified | 2026-08-11 | 2026-08-11 | #112 / !63 |
| 20 | CF-020 | Topic contracts name Workspace as bus publisher for UI-originated topics while ADR-007/009/010 require BFF/Orchestration edges and forbid clientâ†’broker publish | Medium | verified | 2026-08-11 | 2026-08-11 | #115 / !66 |
...
| 23 | CF-023 | research/adr-candidates/README still says ADR-006â€¦010 gate slots are open though those ADRs are Accepted | Low | verified | 2026-08-11 | 2026-08-11 | #118 / !69 |
| 24 | CF-024 | ADR-009 still says BFF â€œif introduced by deployment ADRsâ€ though ADR-007 Accepted a separate BFF | Low | verified | 2026-08-11 | 2026-08-11 | #119 / !72 |
...
| 26 | CF-029 | Group milestones M3â€“M7 and Future Backlog reuse M2 description verbatim; M1 description empty | Medium | verified | 2026-08-11 | 2026-08-11 | #124 / !75 |
| 27 | CF-026 | ADR-010 still says Edge/BFF APIs â€œif presentâ€ though ADR-007 Accepted a separate BFF | Low | verified | 2026-08-11 | 2026-08-11 | #125 / !76 |
| 28 | CF-027 | Wiki ADR page still says â€œADR-007 lands with CF-017 / !61â€ though ADR-007 is Accepted on main | Low | verified | 2026-08-11 | 2026-08-11 | #126 / !77 |
...
| 42 | CF-042 | Postâ€“!142 thin FR-003 promotion: closed #22 / figma README / ADR-006 Decision / edge README still say typeÂ·colourÂ·ribbon are Future | Low | verified | 2026-08-14 | 2026-08-14 | #157 / !143 |
...
| 47 | CF-047 | Group milestone descriptions (M4â€“M7, Future Backlog, UX alignment) still list pre-CF-041 coverage and closed â€œcurrentâ€ work | Medium | verified | 2026-08-16 | 2026-08-17 | #191 / !195 Â· #206 / !211 @ 7cae086 |
...
| 50 | CF-050 | Extension migrations 019â€“022 sit outside the only migration runner path while roadmap cites their schemas as delivered artifacts | High | queued | 2026-08-23 | 2026-08-23 | `research/assessments/2026-08-23-codex-independent-runtime-coherence-assessment.md` |
...
4. Classify each result:
   ...
   - **new** â€” assign the next unused `CF-NNN` and append it as `queued`;
   - **duplicate** â€” link it to the existing ID; do not add another active row;
   - **regression** â€” change a previously `verified` finding to `regressed` and
     preserve its old issue/MR links;
   - **still open** â€” retain its active status and update evidence/history;
   - **resolved or rejected** â€” record evidence, but do not silently mark an
...
- Do not overwrite a dirty worktree. Use an isolated worktree for finding
  branches.
- Do not merge casually. Loop ticks must not merge unless
  `@aea-mr-coordinator` was invoked. **Exception:** when that skill is
  invoked and scope, boundary, and validation path all pass, it **must**
  set GitLab auto-merge (`glab mr merge <n> --yes --auto-merge`). Prefer
  MWPS when the pipeline is still running. Do not wait for a second
  â€œplease merge this named MRâ€ prompt. Uncertainty â†’ ask the user; do
  not merge and do not set auto-merge.
...
finding note, andâ€”only if confirmedâ€”follow the coherence findings SOP through
one issue, one isolated branch, one focused fix, and one MR. Do not merge
unless `@aea-mr-coordinator` was invoked and its merge gates pass (then
that skill must set auto-merge; do not wait for a second merge prompt).
...
1. **Session loop** â€” `/loop 1h` (or an armed `AGENT_LOOP_TICK_coherence` shell) runs
   the **Hourly tick prompt** below in this Agents chat until stopped.
2. **Cursor Automation** (optional, persists outside the chat) â€” schedule
...
3. If any row is queued or regressed: run ONE remediation iteration on the first
   such row (severity then dependency). Reproduce; if confirmed, one issue â†’ one
   isolated branch â†’ one focused fix â†’ one MR. Loop ticks must not merge.
   Merge only if `@aea-mr-coordinator` was invoked and its merge gates
   pass (then that skill must set auto-merge).
