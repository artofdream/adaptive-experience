...
Both v8 installs are signed and distributed by Google Play (`com.android.vending`) with no debug flag. This session did not inspect the sponsor evidence directories (`C:\Users\claud\Temp\aea-v8\evidence\`, `C:\Users\claud\Temp\aea-rog-404\`, `C:\Users\claud\Temp\aea-rog-reorder-2026-09-09\`).
